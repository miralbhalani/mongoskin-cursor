...
var SkinCursorAggregate = require('./cursor_aggregate').SkinCursor;
...
SkinCollection.prototype.aggregate = function (query, options, callback) { 
  ...
  if (args.length > 0 && typeof args[args.length - 1] === 'function') {    
    ...
    var cursor = new SkinCursorAggregate();   
    cursor._skin_collection = this;
    cursor._find_args = args;   
    return cursor;
  }
...
SkinCollection.prototype.aggregateAsync = bird.promisify(SkinCollection.prototype.aggregate);